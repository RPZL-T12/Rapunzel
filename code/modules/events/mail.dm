...
/datum/event/mail/announce()
	command_announcement.Announce("A batch of mail adressed to the crew of \the [location_name()] has arrived at the sorting office and will arrive on the next available supply shuttle.", pick("Major Bill's Shipping", "SolX Freight", "QuiCo. Mailing Services"), zlevels = affecting_z)
